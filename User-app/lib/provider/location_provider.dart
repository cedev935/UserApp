...
class LocationProvider with ChangeNotifier {
  ...
  Position _position = Position(longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, altitudeAccuracy: 0.0, headingAccuracy: 0.0);
  ...
  void getCurrentLocation(BuildContext context, bool fromAddress, {GoogleMapController? mapController}) async {
    ...
    try {
      ...
      myPosition = Position(
        ...
        timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, altitudeAccuracy: 0.0, headingAccuracy: 0.0,
      );
    }
    if(fromAddress) {
      ...
      try {
        if (fromAddress) {
          _position = Position(
            ...
            heading: 1, accuracy: 1, altitude: 1, speedAccuracy: 1, speed: 1, altitudeAccuracy: 0.0, headingAccuracy: 0.0,
          );
        } else {
